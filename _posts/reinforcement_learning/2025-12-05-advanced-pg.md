...
<img src="{{'/assets/images/reinforcement_learning/step_in_policy.png' | relative_url}}" alt="Explained variance vs number of components"><figcaption>
  <strong>Figure 1.</strong> Explained variance as a function of the number of principal components
  </figcaption>
</figure>
...
<p align="center">
<img src="/assets/images/reinforcement_learning/step_in_policy_01.png" alt="Step in Policy Space" width="300"/>
</p>
...
<p align="center">
<img src="/assets/images/reinforcement_learning/step_size_issue_pg.png" alt="Step size issue " width="300"/>
</p>
...
<div class="admonition tip">
  ...
  <p>In the PG algorithm, we typically throw away the samples generated from the old policy, and generate a new set of samples after every update.</p>
</div>
...
And a new objective function ${\mathcal{L}\_{\pi_{\theta}}}$, called the surrogate loss function, is used. Therefore, in place of the start state objective, our new objective has two terms. And our goal is to:
...
Represents the KL divergence for a particular state $s$. But here we bar in the KL divergence term $\bar{D}\_{KL}(\pi\_{\theta} \|\| \pi\_{\theta\_k})$ because it represents the average of the distances over all possible states of the MDP, $\frac{1}{\|\mathcal{S}\|} \sum_{s \in \mathcal{S}} D_{KL}(s)$.

<p align="left">
<img src="/assets/images/reinforcement_learning/ppo_kl_algo.png" alt="PPO with KL constraint" width="600"/>
</p>
...
<p align="center">
<img src="/assets/images/reinforcement_learning/ppo_clipped.png" alt="PPO with clipped objective" width="600"/>
</p>
...
<p align="left">
<img src="/assets/images/reinforcement_learning/ppo_clipped_algo.png" alt="PPO with Clipped Objective" width="600"/>
</p>

Clipping prevents the new policy $\pi_{\theta_{k+1}}$ to go far away from $\pi_{\theta_k}$.

NOTE: PPO doesn't carry any theoretical guarantee, but works well in practice. Other popular advanced policy gradient methods are Natural Policy Gradient and TRPO. They both carry theoretical guarantee.
